...
public class TileView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        System.out.println("mTileSize is" + mTileSize);
        System.out.println("Width is" + w);
        System.out.println("Height is" + h);
        System.out.println("mXTileCount is" + mXTileCount);
        System.out.println("mYTileCount is" + mYTileCount);        
        System.out.println("mXOffset is" + mXOffset);
        System.out.println("mYOffset is" + mYOffset);   
        
        //In nexus7, we get:
        //mTileSize = 48; width: 1200; height: 1774; mxTileCount: 25; mYTileCount: 36; MXOffset:0; mYOffset: 23;
        //why not 1900? because the title occupy some space.
